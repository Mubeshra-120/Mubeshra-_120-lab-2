...
using namespace std;
//int main() {
//int* ptr = new int; // Allocate memory for anintegerdynamically
//*ptr = 10;
...
//}
//int main() {
//void (*ptr)() = showMessage; // Pointer to a functionptr(); // Call the function using the pointer
//return 0;
//}
...
//Rectangle r(5, 3);
//Rectangle *ptr = &r;
//std::cout << "Area of the rectangle: " << ptr->area() <<std::endl;
//return 0;
//}
